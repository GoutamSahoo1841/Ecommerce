    ...
    <div className="flex justify-center mt-12 mb-20 px-4">
      <div className="w-full max-w-md bg-card border border-border/50 p-8 sm:p-10 rounded-3xl shadow-lg relative">
        ...
        <div className="text-center mb-8 mt-6">
          ...
          <h1 className="text-2xl font-extrabold text-foreground mt-4">Create your account</h1>
          <p className="text-sm text-muted-foreground mt-1">Start your shopping journey today</p>
        </div>
        ...
        <form onSubmit={submitHandler} className="space-y-5">
          <div className="space-y-1.5">
            ...
            <div className="relative flex items-center">
              <User className="absolute left-3.5 text-muted-foreground/55 h-4.5 w-4.5" />
              <input
                type="text"
          ...
          <div className="flex items-start gap-2 text-xs">
            <input 
              ...
              className="mt-0.5 h-4 w-4 rounded border-border text-primary focus:ring-primary/25 cursor-pointer accent-primary" 
              required
            />
            <label htmlFor="agree-checkbox" className="font-medium text-muted-foreground cursor-pointer select-none leading-normal">
              I agree to the{' '}
              <a href="/terms" onClick={(e) => { e.preventDefault(); toast.info('Terms of Service is a mockup'); }} className="text-primary hover:underline font-semibold">Terms of Service</a>
              {' '}and{' '}
              <a href="/privacy" onClick={(e) => { e.preventDefault(); toast.info('Privacy Policy is a mockup'); }} className="text-primary hover:underline font-semibold">Privacy Policy</a>
            </label>
          </div>
